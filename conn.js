...
var bg_lexxy = '6281242648600@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by HumanBot' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: 'Bot MD', author: 'By HumanBot' }
